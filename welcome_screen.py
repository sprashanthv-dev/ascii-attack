...
class WelcomeScreen:
    def __init__(self, game_manager):
        ...
        self.start_game = Button(self.screen, "New Game", 514, 200)
        self.view_rules = Button(self.screen, "Rules", 514, 250)
        self.view_leaderboard = Button(self.screen, "Leaderboard", 514, 300)
        self.quit_game = Button(self.screen, "Quit", 514, 350)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if self.start_game.is_over(mouse_pos):
                    ...
                    pass
                elif self.view_rules.is_over(mouse_pos):
                    # TODO: Handle view rules action
                    pass
                elif self.view_leaderboard.is_over(mouse_pos):
                    # TODO: Handle view leaderboard action
                    pass
                elif self.quit_game.is_over(mouse_pos):
                    pygame.quit()
